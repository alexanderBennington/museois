...
function obtenerValores(e) {
    ...
    document.getElementById('a5').value = elementosTD[6].innerHTML;
    document.getElementById('a6').value = elementosTD[0].innerHTML;
    document.getElementById('a7').value = elementosTD[1].innerHTML;
    document.getElementById('a8').value = elementosTD[2].innerHTML;
}