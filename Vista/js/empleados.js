...
function obtenerValores(e) {
    ...
    document.getElementById('e5').value = elementosTD[6].innerHTML;
    document.getElementById('e6').value = elementosTD[7].innerHTML;
    document.getElementById('e7').value = elementosTD[8].innerHTML;
    document.getElementById('e8').value = elementosTD[4].innerHTML;
    document.getElementById('e9').value = elementosTD[13].innerHTML;
    document.getElementById('e10').value = elementosTD[14].innerHTML;
    document.getElementById('e11').value = elementosTD[0].innerHTML;
    document.getElementById('e12').value = elementosTD[1].innerHTML;
    document.getElementById('e13').value = elementosTD[2].innerHTML;
    document.getElementById('e14').value = elementosTD[3].innerHTML;
}