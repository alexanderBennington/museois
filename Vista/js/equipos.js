...
function obtenerValores(e) {
    ...
    document.getElementById('a3').value = elementosTD[3].innerHTML;
    document.getElementById('a4').value = elementosTD[0].innerHTML;
    document.getElementById('a5').value = elementosTD[1].innerHTML;
    document.getElementById('a6').value = elementosTD[3].innerHTML;
}